defmodule AuthUbGu.Accounts.User do
  use Ecto.Schema
  ...
  typed_schema "users" do
    ...
    # TODO: test if nil default works
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, AuthUbGu.Repo)
  ...
  """
  def valid_password?(%AuthUbGu.Accounts.User{hashed_password: hashed_password}, password)
